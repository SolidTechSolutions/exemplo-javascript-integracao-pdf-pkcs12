# 🇧🇷 SolidSign API - Exemplo de Integração: Assinatura PAdES (PDF) com PKCS#12 (certificado pré-importado) (JavaScript)
...
# 🇬🇧 SolidSign API - Integration Example: PAdES (PDF) Signing with PKCS#12 (pre-imported certificate) (JavaScript)
